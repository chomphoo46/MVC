...
class WhiteCowGUI:
    ...
    def add_buttons(self):
        ...
        tk.Button(self.root, text="ป้อนมะนาวเพื่อผลิตนมเปรี้ยว", command=self.add_lemon, font=('Arial', 14)).pack(pady=10)
    ...
    def add_lemon(self):
        messagebox.showinfo("ป้อนมะนาว", self.cow.add_lemon())
    ...
    def show_report(self):
        ...
        report = (f"รายงานการผลิตนม:\n"
                  f"นมจืด: {milk_count['จืด']} ขวด\n"
                  f"นมเปรี้ยว: {milk_count['เปรี้ยว']} ขวด\n"
                  f"นมถั่วเหลือง: {milk_count['ถั่วเหลือง']} ขวด\n"
